"""
components.py — Reusable UI rendering functions for the PulseEngine local dashboard.
...
def _build_logo_html() -> str:
    logo_path = Path(__file__).resolve().parents[2] / "assets" / "logo" / "pulseengine_logo.png"
    if logo_path.exists():
